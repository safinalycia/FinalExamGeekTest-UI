...
public class MyPostPage extends AbstractPage{
    ...
    //элементы с локацией для страницы выдача своих постов:
...
//геттеры, конструкторы :
    ...
    // геттеры для страниц с постами на своей странице (title, description, img):
    ...
    //геттеры для соотношения сторон картинок:
